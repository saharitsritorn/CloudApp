...
* **ml** <br> เป็น flask ที่จะเรียก script  ตัว แยกเสียงแยกได้สองคนเท่านั้น pretrain model ที่ใช้มี
    ...
    * whisper  ของ openai ใช้ แปลงเสียงเป็น text 
    ...
    > * <ml:5000/> จะเป็น route ที่จะreturn string "Please wait while the audio is being processed." เมื่อ ยังประมวลผมไม่เสร็จ
...
<br> มี bug ที่javascript(/CloudApp/client/public/index.html:211) ไม่สามารถดึงget api ของ **ml:5000/example** ได้ แต่ลองใช้ curl จาก **client** ไป get **ml:5000** 
